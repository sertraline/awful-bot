...
class NewMessageObserver():
    ...
    async def new_message(self, event=None):
        ...
        if not check:
            self.debug(f"User or chat blacklisted: {from_id}, {to_id}")
            return
